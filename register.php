...
<head>
	...
	<div class="row">
      <div class="col-md-12">
        <center><h3 class="column-title">Register</h3></center>
        <form id="contact-form" action="#" method="post" role="form" style>
          <div class="error-container"></div>
          <center><div>
            <div><br>
              <div class="form-group">
                
                <input class="form-control form-control-name" name="name" id="name" placeholder="first name" type="text" required style="width:400px; height:50px;box-shadow: 10px 10px 5px lightblue;"><br><br>
              </div>
            </div>
			...
			<div>
              <div class="form-group">
                ...
                <input class="form-control form-control-name" name="name" id="name" placeholder="last name" type="text" required style="width:400px; height:50px;box-shadow: 10px 10px 5px lightblue;"><br><br>
              </div>
            </div>
			...
			<div>
              <div class="form-group">
                ...
                <input class="form-control form-control-name" name="name" id="name" placeholder="mobile no" type="text" required style="width:400px; height:50px;box-shadow: 10px 10px 5px lightblue;"><br><br>
              </div>
            </div>
            <div>
              <div class="form-group">
                <input class="form-control form-control-password" name="email" id="password" placeholder="Password" type="password" required style="width:400px;height:50px;box-shadow: 10px 10px 5px lightblue;">
              </div>
            </div>
          </div></center>
          <div class="text-center"><br>
            <button class="btn btn-primary solid blank" type="submit" style="width:120px;border-radius:20px;">Register</button>
          </div>
        </form>
      </div>
    </div>
